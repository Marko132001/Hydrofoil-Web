        ...
        <>
            ...
            <main className="mt-10">
                <div className="mb-4 md:mb-0 w-full mx-auto relative">
                    ...
                    <img className="w-full object-cover lg:rounded" src={process.env.IMAGES_STRAPI_URL + post.data.attributes.image.data.attributes.url} style={{height: '28em'}} />
                </div>
            ...
            {
            (post.data.attributes.gallery != null) &&
            <GridGallery element={post.data.attributes.gallery} />
            }
        </>
    );
}
