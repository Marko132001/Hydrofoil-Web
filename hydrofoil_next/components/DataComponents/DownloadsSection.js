...
function DownloadsSection({t}) {
        ...
        return(
            ...
            <section
                ...
                <div className="mx-3 px-1 py-10 max-w-[43rem]   rounded-xl bg-blue-300 bg-opacity-50 shadow-lg backdrop-blur-md">
                    <div className="text-center">
                    <h1 className="mt-3 text-[3.5rem] font-bold leading-[4rem] tracking-tight text-black">Open Source</h1>
            ...
            <div className="antialiased w-full h-full text-gray-400 font-inter">
                ...
                <div>
                    ...
                    <div
                        id="plan"
                        className="rounded-lg text-center overflow-hidden w-full transform hover:shadow-2xl hover:scale-105 hover:backdrop-blur-sm transition duration-200 ease-in"
                    >
                        <div id="title" className="w-full py-5 border-b-2 border-blue-400">
                        <h2 className="font-bold text-3xl text-white">{t("open-source:card_title")}</h2>
                        ...
                        <div id="contain" className="leading-8 mb-10 text-lg font-light text-gray-50">
                            <ul>
