                ...
                <section className="dark:bg-gray-800 dark:text-gray-100">
                    <div className="container max-w-6xl p-6 mx-auto space-y-6 sm:space-y-12">
                        ...
                        <a href="#" className="block max-w-sm gap-3 mx-auto sm:max-w-full group hover:no-underline focus:no-underline lg:grid lg:grid-cols-12 dark:bg-gray-900">
                            <img src={process.env.IMAGES_STRAPI_URL + posts.data[0].attributes.image.data.attributes.url} alt="" className="object-cover w-full h-44 rounded sm:h-96 lg:col-span-7 dark:bg-gray-500" />
